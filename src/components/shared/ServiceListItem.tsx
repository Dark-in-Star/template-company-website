...
export function ServiceListItem({ service, align }: ServiceListItemProps) {
  ...
  return (
    <div className="grid grid-cols-1 items-center gap-8 md:grid-cols-2 md:gap-16">
        <div className={cn('relative h-80 w-full overflow-hidden rounded-lg', isLeftAligned ? 'md:order-1' : 'md:order-2')}>
            <Image
        ...
        <div className={cn('flex flex-col justify-center space-y-4', isLeftAligned ? 'md:order-2' : 'md:order-1')}>
