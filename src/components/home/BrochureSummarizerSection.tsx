            ...
            <CardContent className="p-8 md:p-12">
                <div className="grid grid-cols-1 items-center gap-8 text-center md:grid-cols-3 md:text-left">
                    <div className="flex items-center justify-center gap-4 md:col-span-1">
                        ...
                        <Bot className="hidden h-20 w-20 text-primary/80 sm:block" />
                    </div>
                    <div className="md:col-span-2">
                        <h2 className="font-heading text-2xl font-bold tracking-tighter text-foreground sm:text-3xl">
                        ...
                        <Link href="/summarize-brochure" className="mt-6 inline-block">
                            <Button variant="default" size="lg">Try the AI Tool Now</Button>
                        </Link>
                    </div>
                </div>
            </CardContent>
