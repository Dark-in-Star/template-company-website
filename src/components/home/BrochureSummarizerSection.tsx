  ...
  return (
    <section>
      <div className="container mx-auto">
        <div className="rounded-lg border border-border/20 bg-gradient-to-br from-background via-primary/10 to-secondary/10 p-8 shadow-lg backdrop-blur-lg md:p-12">
