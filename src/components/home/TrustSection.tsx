...
export function TrustSection() {
    ...
    return (
        <>
            <section className="bg-transparent container -mt-15 pb-16 relative z-10">
                <div className="container mx-auto">
                    <Card className="bg-card text-card-foreground px-8 py-6 shadow-2xl lg:rounded-full backdrop-blur-sm  ">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">

                            <div className="flex flex-col pl-5 justify-center items-center md:items-start text-center md:text-left">
                            ...
                            <div className="md:col-span-2  grid grid-cols-1 sm:grid-cols-3 gap-4 items-center">
                                <Card className="bg-transparent overflow-hidden group sm:rounded-l-full" onClick={() => setShowVideo(true)}>
                                ...
                                <Card className="bg-black/40  backdrop-blur-md sm:rounded-r-full">
                                     <CardContent className="p-4 flex flex-col justify-center items-center text-center h-40">
