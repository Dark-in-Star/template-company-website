  ...
  return (
    <div className="container mx-auto py-16">
      ...
      <div className="prose dark:prose-invert max-w-none">
        ...
        <p>
          ...
          <ul>
            <li>
              ...
              include your computer’s Internet Protocol (IP) address, your browser type
            ...
            <li>
              ...
              information, such as your name, email, social media profiles, phone/mobile
        ...
        <h2 className="font-heading text-3xl">4. Changes to This Privacy Policy</h2>
        <p>
        ...
        <h2 className="font-heading text-3xl">5. Contact Us</h2>
        <p>
