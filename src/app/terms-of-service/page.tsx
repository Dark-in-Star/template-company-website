  ...
  return (
    <div className="container mx-auto py-16">
      ...
      <div className="prose dark:prose-invert max-w-none">
        ...
        <h2 className="font-heading text-3xl">2. Use License</h2>
        <ol type="a">
          <li>
        ...
        <h2 className="font-heading text-3xl">3. Disclaimer</h2>
        <p>
        ...
        <h2 className="font-heading text-3xl">4. Limitations</h2>
        <p>
        ...
        <h2 className="font-heading text-3xl">5. Governing Law</h2>
        <p>
